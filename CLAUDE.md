...
This file is read automatically by Claude Code on every session in this repository.
...
```text
CLAUDE.md            # Claude Code native project rules (this file)
AGENTS.md            # AI agent / LLM project rules (synced with CLAUDE.md)
...
**Always:**
1. Read this file and `AGENTS.md` before making non-trivial changes.
