...
void main() {
  group('SaFrameworkLocalizationsDelegates', () {
    test(
      'SaMaterialLocalizationsDelegate supports sa only and loads en',
      () async {
    ...
    test(
      'SaCupertinoLocalizationsDelegate supports sa only and loads en',
      () async {
    ...
    test(
      'SaWidgetsLocalizationsDelegate supports sa only and loads en',
      () async {
