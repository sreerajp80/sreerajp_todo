...
void main() {
  ...
  test('incomplete task created on day 1 appears on both day 1 and day 2 when carried forward', () async {
    final todo = makeTodo(
      id: 'task-1',
      date: '2026-09-20',
  ...
  test('completing a task on day 2 shows completed on day 2 and pending on day 1', () async {
    final todo = makeTodo(
      id: 'task-2',
      date: '2026-09-20',
  ...
  test('time segments query separates today elapsed time from total lifetime time', () async {
    final todo = makeTodo(
      id: 'task-3',
      date: '2026-09-20',
    ...
    final totalElapsed = await timeSegmentRepo.getTotalElapsedSeconds('task-3');
  ...
  test('renaming task across active dates throws MultiDayDuplicateTitleException on clash', () async {
  ...
  test('deleteTodoFromDate drops task from today onwards and preserves past records', () async {
    final todo = makeTodo(
      id: 'task-del',
      date: '2026-09-21',
      sourceDate: '2026-09-20',
    ...
    await todoRepo.deleteTodoFromDate('task-del', '2026-09-21', bypassLock: true);
