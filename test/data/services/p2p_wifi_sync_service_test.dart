...
void main() {
  ...
  group('P2pWifiSyncService Unit Tests', () {
    ...
    test('buildPayload constructs valid P2pSyncPayload from database', () async {
    ...
    test('mergeIncomingPayload performs Add-Only Non-Destructive Merge', () async {
      final today = todayAsIso();
    ...
    test('P2pSyncPayload deserialization truncates fields exceeding 4KB cap', () {
      ...
      expect(payload.todos.first.title.length, equals(P2pSyncBounds.maxFieldLen));
    });
  });
}
