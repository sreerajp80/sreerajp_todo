...
void main() {
  group('Codebase Guidelines Compliance (§7.8, §8.1, §8.7)', () {
    test('build.gradle.kts disables Android language bundle splitting (§8.1)', () {
    ...
    test('All IconButton declarations in lib/presentation specify tooltip (§7.8)', () {
    ...
    test('All FloatingActionButton declarations in lib/presentation specify tooltip (§7.8)', () {
      final dir = Directory('lib/presentation');
      final files = dir
          .listSync(recursive: true)
          .whereType<File>()
    ...
    testWidgets('expectAllIconButtonsHaveTooltips correctly detects icon buttons and FABs (§7.8)', (tester) async {
